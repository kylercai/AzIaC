...
param virtualNetworkName string = 'k2Vnet'
...
param k2SubnetName string = 'k2WorkflowVMSubnet'
...
param k2SQLSubnetName string = 'k2WorkflowSQLVMSubnet'

@description('Specifies the K2 workflow engine MySQL subnet IP prefix. This prefix must be within vnet IP prefix address space.')
param k2MySQLSubnetAddressPrefix string = '10.1.4.0/24'

@description('Specifies the k2 MySQL PaaS subnet name.')
param k2MySQLSubnetName string = 'k2WorkflowMySQLSubnet'
...
module vnet 'vnet.bicep' = {
  ...
  params: {
    ...
    k2SubnetName: k2SubnetName
    k2SubnetAddressPrefix: k2SubnetAddressPrefix
    k2SQLSubnetName: k2SQLSubnetName
    k2SQLSubnetAddressPrefix: k2SQLSubnetAddressPrefix
    k2MySQLSubnetName: k2MySQLSubnetName
    k2MySQLSubnetAddressPrefix: k2MySQLSubnetAddressPrefix
  }
}
